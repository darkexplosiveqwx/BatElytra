...
public class Gui extends GuiComponent {
   ...
   public void renderSpyglassOverlay(PoseStack p_265563_, float p_265127_) {
      RenderSystem.disableDepthTest();
      RenderSystem.depthMask(false);
   ...
   public void renderVignette(PoseStack p_265650_, Entity p_265294_) {
   ...
   protected void renderPortalOverlay(PoseStack p_265769_, float p_265121_) {
      if (p_265121_ < 1.0F) {
         p_265121_ *= p_265121_;
         p_265121_ *= p_265121_;
