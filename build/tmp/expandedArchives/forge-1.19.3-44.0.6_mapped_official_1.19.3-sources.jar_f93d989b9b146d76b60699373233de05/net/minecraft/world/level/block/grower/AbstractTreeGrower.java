...
public abstract class AbstractTreeGrower {
   ...
   public boolean growTree(ServerLevel p_222905_, ChunkGenerator p_222906_, BlockPos p_222907_, BlockState p_222908_, RandomSource p_222909_) {
      ...
      if (resourcekey == null) {
         ...
         Holder<? extends ConfiguredFeature<?, ?>> holder = this.getConfiguredFeature(p_222905_, p_222906_, p_222907_, p_222908_, p_222909_, this.hasFlowers(p_222905_, p_222907_), resourcekey);
